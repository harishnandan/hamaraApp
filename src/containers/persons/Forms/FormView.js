...
class DataForm extends Component {
  ...
  static propTypes = {
    ...
    formType: PropTypes.oneOf(['DocotorMeeting', 'ChemistMeeting', 'AddNew', 'Edit']),
  ...
  constructor(props) {
    ...
    if (props.formFields.indexOf('Phone') > -1) formFields.Phone = this.String;
    if (props.formFields.indexOf('Address') > -1) formFields.Address = this.String;
    if (props.formFields.indexOf('Products') > -1) formFields.Products = this.String;
    if (props.formFields.indexOf('Quantity') > -1) formFields.Quantity = this.String;
